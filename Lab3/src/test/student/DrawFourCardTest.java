...
public class DrawFourCardTest {
    ...
    void testPlay() {
    	...
    	NumberCard c7 = new NumberCard(CardColor.GREEN, CardSymbol.ZERO);
    	NumberCard c8 = new NumberCard(CardColor.BLUE, CardSymbol.ZERO);
    	DrawFourCard c9 = new DrawFourCard();
    	gameInstance.getPlayerHand(0).add(c2);
    	
    	gameInstance.getPlayerHand(1).add(c4);
    	gameInstance.getPlayerHand(1).add(c7);
    	
    	gameInstance.getPlayerHand(2).add(c5);
    	gameInstance.getPlayerHand(2).add(c8);
    	
    	gameInstance.getPlayerHand(3).add(c9);
